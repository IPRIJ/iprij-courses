...
<details>
<summary><strong>Question 1 : Qu'est-ce que WordPress ?</strong></summary>

**Réponse :** WordPress est un système de gestion de contenu (CMS) gratuit et open source qui permet de créer des sites web sans programmation.
</details>

<details>
<summary><strong>Question 2 : Quelle est la part de marché de WordPress ?</strong></summary>

**Réponse :** Plus de 43% de tous les sites web dans le monde utilisent WordPress.
</details>

<details>
<summary><strong>Question 3 : Citez 3 avantages de WordPress</strong></summary>

**Réponse possible :** 
1. Gratuit et open source
2. Interface intuitive 
3. Grande communauté et support
</details>
...
<details>
<summary><strong>WordPress est-il vraiment gratuit ?</strong></summary>
Oui, le logiciel WordPress est 100% gratuit. Vous payez seulement l'hébergement et éventuellement un nom de domaine.
</details>

<details>
<summary><strong>Faut-il savoir coder pour utiliser WordPress ?</strong></summary>
Non, WordPress est conçu pour être utilisé sans connaissances en programmation. Cependant, des bases en HTML/CSS peuvent être utiles pour des personnalisations avancées.
</details>

<details>
<summary><strong>Quelle est la différence entre WordPress.org et WordPress.com ?</strong></summary>
WordPress.org est la version auto-hébergée (gratuite, contrôle total). WordPress.com est un service d'hébergement avec plans payants et limitations.
</details>
